	...
	<div class="container w-75 mt-5 mx-auto">
		...
		<ul class="list-group">
			<c:forEach var="news" items="${newslist}">
				<li><a href="ncontrol?action=getNews&aid">${news.title},${news.date}</a>
				</li>
			</c:forEach>
		</ul>
		<hr>
		...
		<div class="collapse" id="addForm">
			<div class="card card-body">
				<form method="post" action="/JSP2023/ncontrol?action=addNews"
					enctype="multipart/form-data">
					<label class="form-label">제목</label> <input type="text"
						name="title" class="form-control"> <label
						class="form-label">이미지</label> <input type="file" name="file"
						class="form-control"> <label class="form-label">기사내용</label>
